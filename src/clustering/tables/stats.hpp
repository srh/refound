...
#ifndef CLUSTERING_ADMINISTRATION_TABLES_STATS_HPP_
#define CLUSTERING_ADMINISTRATION_TABLES_STATS_HPP_
...
{
public:
    explicit stats_artificial_table_fdb_backend_t(
            admin_identifier_format_t _identifier_format);
    ~stats_artificial_table_fdb_backend_t();
...
#endif /* CLUSTERING_ADMINISTRATION_TABLES_STATS_HPP_ */
